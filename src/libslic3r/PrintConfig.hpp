...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBools,               sla_material_extruder))
    ((ConfigOptionFloats,              sla_material_exposure_time))
    ((ConfigOptionFloats,              sla_material_delay_before_exposure))
    ((ConfigOptionFloats,              sla_material_delay_after_exposure))
    ((ConfigOptionBools,               sla_material_video_synthesize))
    ((ConfigOptionStrings,             sla_material_video_names))
    ((ConfigOptionStrings,             sla_material_video_paths))
    ((ConfigOptionStrings,             channel_type))
    ((ConfigOptionStrings,             channel_label))
    ((ConfigOptionBools,               sla_material_video_embed))
    ((ConfigOptionInt,                 sla_material_video_synth_width))
    ((ConfigOptionInt,                 sla_material_video_synth_height))
    ((ConfigOptionFloat,               sla_material_video_synth_proj_width))
    ((ConfigOptionFloat,               sla_material_video_synth_proj_height))
    ((ConfigOptionInt,                 sla_material_video_synth_fps))
    ((ConfigOptionBool,                sla_material_video_synth_lossless))
)
